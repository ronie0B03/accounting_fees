...
$getCashierAccount = mysqli_query($mysqli, " SELECT * FROM accounts WHERE role = 'user' ");
                        ...
                        <form method="post" action="process_receipt.php">
                            <table class="table" width="100%" cellspacing="0" id="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="cashier_account">
                                            <option value='all'>All Cashiers</option>
                                            
                                            <?php while ($newCashierAccount = $getCashierAccount->fetch_assoc()) { ?>
                                                <option value="<?php echo $newCashierAccount['full_name']; ?>"><?php echo $newCashierAccount['full_name']; ?></option>
                                            <?php } ?>
